...
?>">
    <div class="comment-author">
		<?php $comments->gravatar(45, 'X', '', 'avatar'); ?>
	</div>
    <div class="comment-meta">
       <cite class="fn"><?php $singleCommentOptions->beforeAuthor();
                $comments->author();$singleCommentOptions->afterAuthor();  ?></cite>
				
				<a href="<?php $comments->permalink(); ?>"><?php $comments->date('Y.m.d'); ?></a> <span class="comment-reply"><?php $comments->reply($singleCommentOptions->replyWord); ?></span>
    </div>
    <div class="comment-p">
